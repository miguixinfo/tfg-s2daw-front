...
async function onHandleSubmit() {
  ...
  data.descripttion = document.getElementById('description').value;
  ...
  const request = await fetch('http://localhost:8080/api/cableTrays', {
    method: 'POST',
    headers: {
  ...
  window.location.href = '/cableTrays';
}

function AddCableTray() {
  return (
    <div className="container mt-5">
      <h2>Añade una bandeja para cables</h2>
