...
async function onHandleSubmit() {
  ...
  const request = await fetch('http://localhost:8080/api/ethernetCables', {
    method: 'POST',
    headers: {
  ...
  window.location.href = '/ethernetCables';
}

function AddEthernetCable() {
  return (
    <div className="container mt-5">
      <h2>Añade un Cable Ethernet</h2>
...
export default AddEthernetCable;
